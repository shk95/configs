...
generated configuration without a physical display. The desired state has not
yet been activated on either installed guest, and the desktop is not installed
(`docs/policy/decisions/unixlike/shared-linux-graphical-base-is-niri-and-noctalia.md`).
...
(`unixlike/modules/host/utm.nix`), the labelled UEFI/ext4
...
(`unixlike/modules/host/vmware.nix`), the labelled UEFI/ext4
