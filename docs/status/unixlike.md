...
The Linux graphical base is defined but not composed into a declared host.
...
generated configuration without a physical display. No installed host receives
the classes until the later host-adoption order
