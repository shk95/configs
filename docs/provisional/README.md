...
declares the condition that ends it. `docs/policy/architecture.md`, "Provisional
registry", records why the registry exists and how it relates to the other
documents.

This registry is the sibling of `docs/policy/invariants/`. That one records what must
