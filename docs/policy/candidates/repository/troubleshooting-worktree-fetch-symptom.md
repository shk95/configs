...
target: docs/reference/troubleshooting.md, a section keyed on the literal error text, pointing at CONTRIBUTING § Windows changes
...
- `grep -ni 'access rights\|invalid reference' docs/reference/troubleshooting.md` is empty.
