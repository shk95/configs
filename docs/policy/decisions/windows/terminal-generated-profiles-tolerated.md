...
(`docs/policy/decisions/windows/feature-selection-closed.md`). Apply still writes the whole
...
(`docs/policy/decisions/windows/wslconfig-selected-by-windows-build.md`) moved 0.3.0 to 0.4.0.
