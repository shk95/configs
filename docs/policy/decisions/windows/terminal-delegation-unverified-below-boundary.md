...
defined in `docs/policy/architecture.md`. All three are unverified on Windows 10,
...
prerequisite (`docs/policy/decisions/windows/drift-outranks-unverified.md`); #54 remains
