...
status: superseded
issue: #39
superseded-by: docs/policy/decisions/windows/windows-adopts-modus-operandi.md
...
`docs/policy/decisions/windows/windows-adopts-modus-operandi.md`, which names Modus Operandi
