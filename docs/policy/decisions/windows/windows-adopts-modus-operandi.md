...
status: accepted
issue: #164
supersedes: docs/policy/decisions/windows/windows-adopts-catppuccin-latte.md
...
`docs/policy/decisions/unixlike/composed-homes-render-in-declared-terminals.md` rests on. With
...
`docs/policy/decisions/windows/windows-adopts-catppuccin-latte.md` stayed `status: accepted`
...
`docs/policy/decisions/README.md` asks for and left a live-looking record naming a
