...
`docs/policy/candidates/` — and this record is where the reversal is written down.
...
`docs/policy/decisions/unixlike/home-manager-platform-classes.md` records the new kind of
class, `docs/policy/decisions/unixlike/package-ownership-by-generating-module.md` what it
