...
Evaluation and `unixlike/tool/checks/payloads` stop at syntax; a key can parse and
...
home, required by `docs/policy/definition-of-done/unixlike.md`. Enforcement by a check is
