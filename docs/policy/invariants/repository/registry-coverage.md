...
rationale: docs/policy/architecture.md § Invariant registry
enforced-by: tool tool/version-control/invariants
enforced-by: fixture tool/version-control/test
decision: docs/policy/decisions/repository/invariant-registry-created.md § The invariant registry is created with pending entries
