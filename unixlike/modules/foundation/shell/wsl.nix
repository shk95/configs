# The NixOS-WSL account logs into the zsh that modules/foundation/shell/shared.nix configures.
...
# modules/foundation/shell/darwin.nix takes the `programs.zsh` route because nix-darwin's
